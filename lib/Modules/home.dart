  ...
  Widget build(BuildContext context) {
    return Column(children: <Widget>[
      Container(
        ...
        child: Text('👋 Hello', style: TextStyle(fontSize: 20, color: AppTheme.ZK_Olive)),
      )),
      Row(
        ...
        children: <Widget>[
          Container(
            ...
            child: ElevatedButton.icon( 
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all<Color>(AppTheme.ZK_Gray),
          ...
          Container(
            ...
            child: Align(
              alignment: Alignment(-0.90, 0.40),
                child: Text('Announcment', style: TextStyle(fontSize: 25, color: AppTheme.ZK_Olive)),
            )), 
            ]);
  }
}